...
<head>
    ...
    <!-- 图片上传即使预览插件 -->
    <link rel="stylesheet" href="<%=basePath%>statics/css/fileinput.min.css">
        ...
        <div class="main w1200">
            <div class="left">
                <ul>
                    ...
                    <li>
                        <a href="<%=basePath%>user/allGoods"  class="active">
            ...
            <div class="right">
                <div class="tap">
                    <span style="color: black;">我的闲置</span>
                </div>
                <!--

            描述：右侧内容区域
        -->
                <div id="user_content"  style="margin-top: -50%; padding-bottom: 200px;">
                    <div class="share">
                        <!--
                        ...
                        <hr />
                        <div class="share_content" style="margin-top: 90%; margin-left: -35%;">
                            <c:if test="${empty goodsAndImage}">
                                <div class="no_share">
                                    <img src="<%=basePath%>statics/images/no_doc.jpg" width="300px">
                        ...
                        <c:if test="${!empty goodsAndImage}">
                         <c:forEach var="items" items="${goodsAndImage}">
                            <div class="story">
                                ...
                                <span class="name"><h4><strong>${items.goods.name}</strong></h4></span>
                                ...
                                <div class="box">
                                    <div class="box_content">
                                        ...
                                        <%--图片等比例缩放--%>
                                        <img class="primary-img" src="../upload/${items.images[0].imgUrl}" index="2"
                                             style=" width: auto;height: auto;max-width: 100%;max-height: 100%; ">
                                        <span class="com" style="display: none;left: 396.733px;"></span>
                                    </div>
                                    <div class="interact">
                                        <img src="<%=basePath%>statics/images/编辑.png" style="width: 29px;height:29px;"><a href="<%=basePath%>goods/editGoods/${items.goods.id}"
                                                                                                       style="color: teal">编辑</a>
                                        <img src="<%=basePath%>statics/images/更新.png" style="width: 30px;height:30px;"><a href="" style="color: teal">擦亮</a>

                                        <span class="time">${items.goods.startTime}</span>
                                        <img src="<%=basePath%>statics/images/删 除.png" style="width: 30px;height:30px;"><a href="<%=basePath%>goods/deleteGoods/${items.goods.id}"
                                                                                                       onClick="return confirm('确定删除?');" style="color: teal">删除</a>
                                    </div><br>
