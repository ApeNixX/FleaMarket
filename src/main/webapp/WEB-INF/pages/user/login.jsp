        ...
        <div class="container">
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="check-box">
                                        ...
                                        <label for="remember_me">记住</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    <button class="umino-login_btn" type="button" id="button">登录</button>
                                </div>
                ...
                <div class="col-sm-12 col-md-12 col-xs-12 col-lg-8">
                    <img src="<%=basePath%>assets/images/banner/timg1.jpg" style="height: 390px;">
                </div>
