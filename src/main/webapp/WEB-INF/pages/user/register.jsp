        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="login-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="errorRepassword" style="color:red;display:inline;"></div>
                                </div>
                                <div class="col-12">
                                    <button class="umino-register_btn" id="register" type="submit">注册</button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="col-sm-12 col-md-12 col-xs-12 col-lg-6">
                    <img src="<%=basePath%>assets/images/banner/timg2.jpg" style="height: 560px;">
                </div>
            </div>
        </div>
    </div>
