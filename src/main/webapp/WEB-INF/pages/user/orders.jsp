    ...
    <div class="umino-login-register_area" style="margin-top: -2%;">
            ...
            <div class="user-info">
                <div class="w1200">
                    ...
                    <div class="user-account">
                        ...
                        <p class="account">
                        <div style="width: 100%;">
                            <div style="float:left;width: 25%;"><span><a class="btn" style="background-color: rgb(73, 181, 116);color:rgba(255, 255, 255, 1);" href="purse.html">我的钱包：￥${myPurse.balance}</a></span></div>
        ...
        <div class="main w1200">
            <div class="left">
                <ul>
                    <li>
                        <a href="<%=basePath%>orders/myOrders" class="active">
            ...
            <div class="right" style="height: 800px;">
                <div class="tap">
                    <span style="color: black;">订单中心</span>
                </div>
                <!--
...
-->
                <div id="user_content">
                    ...
                    -->
                        ...
                        <hr />
                        <div class="share_content" style="margin-left: 5%;">
                            ...
                            <div class="story" style="width: 78%;">

                                <div class="container" >
                                    <!-- Nav tabs -->
                                    <ul class="nav nav-tabs" role="tablist" style="width: 100%;"  id="myTab">
                                        <!-- <li class="nav-item"><a class="nav-link active"
                                            data-toggle="tab" href="#home">全部订单</a></li> -->
                                        <li class="nav-item"  style="background-color:#fed100;color: white;"><a class="nav-link active" data-toggle="tab"
                                                                      href="#orders_my" >我买的</a></li>
                                        <li class="nav-item"  style="background-color:#fed100;color: white;"><a class="nav-link" data-toggle="tab"
                                    ...
                                    <div class="tab-content" style="width: 100%;">
                                        ...
                                        <div id="orders_other" class="container tab-pane fade"
                                             style="width: 100%;height: 100%;margin-top: -115%;">
                                            <br>
                                            <form class="form-horizontal" role="form">
                                                <div class="table-responsive">
                                                    <table class="table">
                ...
                <!-- <div class="container">
                    <div class="no-doc">
                        <img src="<%=basePath%>statics/images/no_doc.jpg"/>
                        <p>您还没有消息哦~</p>
                    </div>
                </div> -->
            </div>
