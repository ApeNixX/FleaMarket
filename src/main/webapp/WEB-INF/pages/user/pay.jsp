...
<div class="main-wrapper">
    ...
    <div class="umino-login-register_area" style="margin-top: -2%;">
        ...
        <div class="main w1200">
            ...
            <div class="right">
                <div class="tap">
                    <span style="color: black;">确认订单</span>
                </div>
                <!--
                ...
                <div id="user_content">
                    ...
                    -->
                        ...
                        <div class="share_content">
                            <div class="story" style="margin-left: -20%; margin-top: -20%;">
                                <form class="form-horizontal" role="form" action="<%=basePath%>orders/addOrders" >
                                    <h4 >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div style="float:left;height:20px;"><h4>订单编号： </h4></div>
                                        <div style="float:left;height:20px;margin-top: -3px;"><input name="orderNum" class="order-num" readonly="true" type="text" style="border:0px;background:rgba(0, 0, 0, 0); color: #0b2e13;" value=""/></div>
                                        <input name="goodsId" type="hidden" value="${goodsExtend.goods.id}"/> </h4>
                                    <hr/>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="orderPrice" type="text" readonly="true" class="form-control" style="border:0px;background:rgba(0, 0, 0, 0); " value="${goodsExtend.goods.price}">
                                        </div>
                                        <hr/>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-4 col-sm-8">
                                            ...
                                            <c:if test="${myPurse.balance >= goodsExtend.goods.price}"><button type="submit" class="btn btn-info" onclick="return confirm('确定购买吗？')">立即支付</button></c:if>
