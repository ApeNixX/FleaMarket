        ...
        <div class="main w1200">
            <div class="left">
                <ul>
                    ...
                    <li>
                        <a href="<%=basePath%>user/allFocus" class="active">
                                ...
                                <c:forEach var="items" items="${goodsAndImage}">
                                    <div class="story">
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="interact">
                                                <img src="<%=basePath%>statics/images/商店.png" style="width: 28px;height:24px;padding-right: 5px;"><a href="<%=basePath%>goods/goodsId/${items.goods.id}"
                                                                                                                                  style="color: teal">前往购买</a>
                                                <span class="time">${items.goods.startTime}</span>
                                                <img src="<%=basePath%>statics/images/删 除.png" style="width: 30px;height:30px;"><a href="<%=basePath%>user/deleteFocus/${items.goods.id}"
                                                                                                                                   onClick="return confirm('确定取消吗?');" style="color: teal">取消关注</a>
                                            </div><br>
