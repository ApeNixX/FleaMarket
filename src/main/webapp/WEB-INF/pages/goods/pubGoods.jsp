...
<div class="main-wrapper">
    ...
    <div class="umino-login-register_area" style="margin-top: -2%;">
            ...
            <div class="user-info">
                <div class="w1200">
                    ...
                    <div class="user-account">
                        ...
                        <p class="account">
                        <div style="width: 100%;">
                            <div style="float:left;width: 25%;"><span><a class="btn" style="background-color: rgb(73, 181, 116);color:rgba(255, 255, 255, 1);" href="http://localhost:8089/user/myPurse">我的钱包：￥${myPurse.balance}</a></span></div>
        ...
        <div class="main w1200">
            ...
            <div class="right">
                <div class="tap">
                    <span style="color: black;">发布物品</span>
                </div>
                <!--

            描述：右侧内容区域
        -->
                <div id="user_content" style="margin-top: -5%; margin-left: -10%;height: 1200px;">

                    <div class="basic">
                        <form:form id="command" role="form" action="../goods/publishGoodsSubmit" method="post" enctype="multipart/form-data">

                            <div class="changeinfo">
                                <span style="color: black">物品名：</span>
                                <input class="in_info" type="text" name="name" placeholder="请输入物品名" style="background-color: transparent;">
                                <span style="color: red">(*必填)</span>
                            </div>
                            <div class="changeinfo">
                                <span style="color: black">出售价格：</span>
                                <input class="in_info" type="text" name="price" placeholder="请输入出售价格" style="background-color: transparent;">
                                <span style="color: red">(*必填)</span>
                            </div>
                            <div class="changeinfo">
                                <span style="color: black">原价：</span>
                                <input class="in_info" type="text" name="realPrice" placeholder="请输入商品原价" style="background-color: transparent;">
                                <span id="checkphone">(*选填,请如实填写)</span>
                            </div>
                            <div class="changeinfo">
                                <span style="color: black">物品类别：</span>
                                <select class="in_info" name="catelogId" style="background-color: transparent;">
                            ...
                            <%--<div class="form-group">--%>
                                <%--<div class="file-loading">--%>
                                    <%--<input name="myfile" class="file" type="file" data-theme="fas">--%>
                                <%--</div>--%>
                            <%--</div>--%>
                            ...
                            <input type="submit" class="setting-save" value="发布物品" style="margin-left: 5%; background-color: rgb(73, 181, 116);"/>
