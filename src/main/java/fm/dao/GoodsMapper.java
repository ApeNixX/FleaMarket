...
public interface GoodsMapper {
    ...
    List<Goods> getGoodsListOrderByDate();
     ...
     * @return
     */
    List<Goods> getPageGoodsByGoods(@Param("id")Integer id, @Param("name")String name,@Param("status")Integer status,@Param("catelogId")Integer catelogId);
